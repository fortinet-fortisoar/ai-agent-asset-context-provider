...
Enriches hosts, servers, and resources with asset metadata including ownership, criticality levels, data sensitivity classifications, and business function. Provides contextual information to assess asset risk and relevance during incident investigation.
...
| `asset`    | List of assets that needs to be evaluated. |
